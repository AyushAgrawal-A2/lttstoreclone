...
CREATE TABLE "Product" (
    ...
    "ranksId" TEXT NOT NULL,
    "ratingId" TEXT NOT NULL,
    "reviewStatId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_ranksId_key" ON "Product"("ranksId");

-- CreateIndex
CREATE UNIQUE INDEX "Product_ratingId_key" ON "Product"("ratingId");

-- CreateIndex
CREATE UNIQUE INDEX "Product_reviewStatId_key" ON "Product"("reviewStatId");
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_ranksId_fkey" FOREIGN KEY ("ranksId") REFERENCES "Ranks"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_reviewStatId_fkey" FOREIGN KEY ("reviewStatId") REFERENCES "ReviewStat"("id") ON DELETE CASCADE ON UPDATE CASCADE;
