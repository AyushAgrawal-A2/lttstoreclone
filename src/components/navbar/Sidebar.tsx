    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4 py-8 items-center">
          ...
          <Link href={"/collections/accessories"} onClick={hideSideBar}>
            Gear
          </Link>
          <Link href={"/collections/clothing"} onClick={hideSideBar}>
            Clothing
          </Link>
          <Link href={"/collections/all-products-1"} onClick={hideSideBar}>
            All Products
          </Link>
        </div>
        <div className="fixed bottom-4 text-sm">
          <Link href={"/account/login"} onClick={hideSideBar}>
