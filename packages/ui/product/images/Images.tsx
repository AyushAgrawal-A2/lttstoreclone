...
import ProductImages from '@/packages/ui/product/images/ProductImages';
import ProductImagesModal from '@/packages/ui/product/images/ProductImagesModal';
import ProductImagesPreview from '@/packages/ui/product/images/ProductImagesPreview';
...
export default function Images({ title, images }: ImagesProps) {
  ...
  function displayImageModal(idx: number) {
